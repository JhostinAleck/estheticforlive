...
export default function EditarResultadoPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.before_image_url || !formData.after_image_url) {
      toast.error('Debes tener ambas imagenes (antes y despues)')
      return
    }
  ...
  const handleDelete = async () => {
    if (!confirm('Estas seguro de eliminar este resultado? Esta accion no se puede deshacer.')) {
      return
    }
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted">Modifica la transformacion antes/despues</p>
          </div>
          <Button
            variant="outline"
