    ...
    <div className="max-w-2xl mx-auto px-4 md:px-0">
      ...
      <div className="mb-6 md:mb-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            <h1 className="text-xl md:text-2xl font-bold text-secondary">Editar Personal</h1>
            <p className="text-sm md:text-base text-muted">Modifica la información del miembro</p>
          </div>
          <Button
            variant="outline"
