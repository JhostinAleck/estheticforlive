...
export function ResultsCarousel({ results, title, subtitle }: ResultsCarouselProps) {
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            {/* After Image */}
            <Image
              src={currentResult.after_image_url}
              alt="Después"
              fill
            ...
            <div className="absolute inset-0 overflow-hidden" style={{ width: `${sliderPosition}%` }}>
              <div className="relative h-full" style={{ width: `${100 / (sliderPosition / 100)}%`, maxWidth: 'none' }}>
                <Image
                  src={currentResult.before_image_url}
                  alt="Antes"
                  fill
                  className="object-cover"
                  draggable={false}
